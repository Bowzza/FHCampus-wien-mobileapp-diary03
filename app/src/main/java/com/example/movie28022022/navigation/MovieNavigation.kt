...
fun MovieNavigation() {
    ...
    NavHost(navController = navController, startDestination = MovieScreens.HomeScreen.name){
        composable(MovieScreens.HomeScreen.name) { HomeScreen(navController = navController, vm)}
        composable(MovieScreens.FavouriteScreen.name) { FavouriteScreen(navController = navController, vm) }
